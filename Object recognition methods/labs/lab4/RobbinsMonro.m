function rm = RobbinsMonro(X1, X2)
    N = size(X1, 2);
    NIterations = 20000;
    for i=1:NIterations
        for k=1:2
    ...
    fprintf("p1_RobbinsonMonro = %f\n", size(d1rm(d1rm<0),2)/200);
    fprintf("p2_RobbinsonMonro = %f\n", size(d2rm(d2rm>0),2)/200);
    
    drm2 = W(1:2, 1000)'*[x; y]+ W(3, 1000);
    drm3 = W(1:2, 2500)'*[x; y]+ W(3, 2500);
    drm4 = W(1:2, 4500)'*[x; y]+ W(3, 4500);
    drm5 = W(1:2, 6000)'*[x; y]+ W(3, 6000);
