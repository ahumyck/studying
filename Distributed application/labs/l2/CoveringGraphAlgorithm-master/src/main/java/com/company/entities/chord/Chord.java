package com.company.entities.chord;

import com.company.entities.comparators.Interval;
import com.company.entities.exceptions.ChordHasNoActiveNodesException;
import com.company.entities.exceptions.ChordIndexOutOfBoundException;
import com.company.entities.exceptions.ChordNodeIsNotActiveException;
import com.company.entities.table.Calculator;
...
public class Chord {
    ...
    public ChordNode findSuccessor(int id) throws ChordHasNoActiveNodesException, ChordNodeIsNotActiveException {
        if (!this.isEmpty) {
            ...
            if (chordNode.isActive()) return chordNode;
            else {
